...
public:
  int topSpeed;
  Vehicle() { topSpeed = 0; }
  Vehicle(int a) { topSpeed = a; }
  void getTopSpeed() { cout << topSpeed << endl; }
};
...
public:
  ...
  void getMotorType() { cout << "MotorType : Heavy Motor" << endl; }
};
...
public:
  ...
  void getMotorType() { cout << "MotorType : LightMotor" << endl; }
};
...
public:
  ...
  void getPourpose() { cout << "Purpose : For Passenger" << endl; }
};
...
public:
  ...
  void getPurpose() { cout << "Purpose : For Goods" << endl; }
};
...
public:
  ...
  void getCategory() { cout << "Category :  Gear" << endl; }
};
...
public:
  ...
  void getCategory() { cout << "Category :  Non Gear" << endl; }
};
